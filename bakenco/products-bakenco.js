...
(function () {
  ...
  const CONFIG = {
    basePath: "/bakenco",
    imageDir: "/images",
    fallbackImage: "/bakenco/images/bakenco-logo.png",
    businessName: "Bake & Co.",
    businessLogo: "/bakenco/images/bakenco-logo.png",
  ...
  const RAW_PRODUCTS = [
    ...
    { id: "biscoff-bliss-sushi", name: "Biscoff Bliss Sushi", price: 60.00, category: "dessert-sushi", niche: "food-beverages", location: "gauteng", description: "Soft crepes filled with rich brownie, topped with Biscoff drizzle. 3 pieces", badge: "✨ Popular", image: "https://images.unsplash.com/photo-1551024601-bec78aea704b?w=800&auto=format&fit=crop" },
    { id: "chocolate-overload-sushi", name: "Chocolate Overload Sushi", price: 60.00, category: "dessert-sushi", niche: "food-beverages", location: "gauteng", description: "Brownie-filled crepes smothered in chocolate sauce. 3 pieces", badge: "🍫 Best Seller", image: "https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?w=800&auto=format&fit=crop" },
    { id: "bar-one-dream-sushi", name: "Bar One Dream Sushi", price: 65.00, category: "dessert-sushi", niche: "food-beverages", location: "gauteng", description: "Filled with brownie & topped with creamy Bar One sauce. 3 pieces", badge: "🔥 Hot", image: "https://images.unsplash.com/photo-1563729784474-d77dbb933a9e?w=800&auto=format&fit=crop" },
    { id: "bar-one-dream-sushi", name: "Bar One Dream Sushi", price: 65.00, category: "dessert-sushi", niche: "food-beverages", location: "gauteng", description: "Filled with brownie & topped with creamy Bar One sauce. 3 pieces", badge: "🔥 Hot", image: "https://images.unsplash.com/photo-1606890738814-1e18a07c8f5a?w=800&auto=format&fit=crop" },
    { id: "oreo-crunch-sushi", name: "Oreo Crunch Sushi", price: 65.00, category: "dessert-sushi", niche: "food-beverages", location: "gauteng", description: "Brownie crepes topped with crushed Oreos & chocolate drizzle. 3 pieces", badge: "", image: "https://images.unsplash.com/photo-1579372786545-d24232daf58c?w=800&auto=format&fit=crop" },
    { id: "nutella-fantasy-sushi", name: "Nutella Fantasy Sushi", price: 65.00, category: "dessert-sushi", niche: "food-beverages", location: "gauteng", description: "Creamy Nutella filled & drizzled to perfection. 3 pieces", badge: "✨ Premium", image: "https://images.unsplash.com/photo-1499678864852-4f0eb78e1e27?w=800&auto=format&fit=crop" },
